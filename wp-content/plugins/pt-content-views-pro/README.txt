...
= 5.12 =
* Update: [Block] implement "Fields Position" in Block > Layout that can change the display position of fields by drag & drop
* Update: [Block] implement sort by custom field in blocks
* Update: prepend WooCommerce regular price, sale price to the top of custom fields list to select easier
...
= 5.9.2.2 =
Fix regression introduced in 5.9.2 about showing custom field image as thumbnail
